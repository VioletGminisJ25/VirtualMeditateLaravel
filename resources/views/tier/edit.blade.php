                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900 dark:text-gray-100">{{ __('Update') }} Tier</h1>
                            <p class="mt-2 text-sm text-gray-900 dark:text-gray-400">Update existing {{ __('Tier') }}.</p>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="mt-8">
                            <div class="max-w-xl py-2 align-middle">
                                <form method="POST" action="{{ route('tiers.update', $tier->id) }}"  role="form" enctype="multipart/form-data">
                                    {{ method_field('PATCH') }}
                                    @csrf
                                    @include('tier.form')
                                </form>
